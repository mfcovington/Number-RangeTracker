...
subtest 'add various ranges' => sub {
    ...
    $range_ref = { ranges => { 5 => 8, 10 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    ...
    $range_ref = { ranges => { 5 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 5;
    $end       = 25;
    $test_name = "add + collapse range ($start - $end) that begins before 1st and ends between 1st and 2nd";
    $range_ref = { ranges => { 5 => 25, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 5;
    $end       = 45;
    $test_name = "add + collapse range ($start - $end) that begins before 1st and ends in 2nd";
    $range_ref = { ranges => { 5 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 5;
    $end       = 60;
    $test_name = "add + collapse range ($start - $end) that begins before 1st and ends between 2nd and 3rd";
    $range_ref = { ranges => { 5 => 60, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 5;
    $end       = 90;
    $test_name = "add + collapse range ($start - $end) that begins before 1st and ends in 3rd";
    $range_ref = { ranges => { 5 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 15;
    $end       = 20;
    $test_name = "add + collapse range ($start - $end) that begins in 1st and ends in 1st";
    $range_ref = { ranges => { 10 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 15;
    $end       = 25;
    $test_name = "add + collapse range ($start - $end) that begins in 1st and ends between 1st and 2nd";
    $range_ref = { ranges => { 10 => 25, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 15;
    $end       = 45;
    $test_name = "add + collapse range ($start - $end) that begins in 1st and ends in 2nd";
    $range_ref = { ranges => { 10 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 15;
    $end       = 60;
    $test_name = "add + collapse range ($start - $end) that begins in 1st and ends between 2nd and 3rd";
    $range_ref = { ranges => { 10 => 60, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 15;
    $end       = 90;
    $test_name = "add + collapse range ($start - $end) that begins in 1st and ends in 3rd";
    $range_ref = { ranges => { 10 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 25;
    $end       = 30;
    $test_name = "add + collapse range ($start - $end) that begins between 1st and 2nd and ends before 2nd";
    $range_ref = { ranges => { 10 => 20, 25 => 30, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 25;
    $end       = 45;
    $test_name = "add + collapse range ($start - $end) that begins between 1st and 2nd and ends in 2nd";
    $range_ref = { ranges => { 10 => 20, 25 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 25;
    $end       = 60;
    $test_name = "add + collapse range ($start - $end) that begins between 1st and 2nd and ends between 2nd and 3rd";
    $range_ref = { ranges => { 10 => 20, 25 => 60, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 25;
    $end       = 90;
    $test_name = "add + collapse range ($start - $end) that begins between 1st and 2nd and ends in 3rd";
    $range_ref = { ranges => { 10 => 20, 25 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );
    ...
    $range_ref = { ranges => { 10 => 20, 40 => 50, 80 => 100, 120 => 150, 190 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );
    ...
    $range_ref = { ranges => { 10 => 20, 40 => 60, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 251;
    $end       = 300;
    $test_name = "add + collapse range ($start - $end) adjacent to previous range (last range)";
    $range_ref = { ranges => { 10 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 300 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 51;
    $end       = 79;
    $test_name = "add + collapse range ($start - $end) adjacent to both previous and next ranges";
    $range_ref = { ranges => { 10 => 20, 40 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_add_collapse_test( $start, $end, $range_ref, $test_name );
...
subtest 'remove various ranges' => sub {
    ...
    $range_ref = { ranges => { 11 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 0;
    $end       = 15;
    $test_name = "remove + collapse range ($start - $end) that begins before 1st and ends in middle of 1st";
    $range_ref = { ranges => { 16 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 0;
    $end       = 19;
    $test_name = "remove + collapse range ($start - $end) that begins before 1st and ends just before end of 1st";
    $range_ref = { ranges => { 20 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 0;
    $end       = 20;
    $test_name = "remove + collapse range ($start - $end) that begins before 1st and ends at end of 1st";
    $range_ref = { ranges => { 40 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 0;
    $end       = 45;
    $test_name = "remove + collapse range ($start - $end) that begins before 1st and ends in 2nd";
    $range_ref = { ranges => { 46 => 50, 80 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 50;
    $end       = 80;
    $test_name = "remove + collapse range ($start - $end) that begins at end of previous and ends at beginning of next";
    $range_ref = { ranges => { 10 => 20, 40 => 49, 81 => 100, 120 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );
    ...
    $range_ref = { ranges => { 10 => 20, 40 => 50, 80 => 100, 120 => 129, 141 => 150, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 75;
    $end       = 175;
    $test_name = "remove + collapse range ($start - $end) begins and ends outside of multiple ranges";
    $range_ref = { ranges => { 10 => 20, 40 => 50, 200 => 250 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );

    $start     = 240;
    $end       = 260;
    $test_name = "remove + collapse range ($start - $end) that begins in last range and ends after";
    $range_ref = { ranges => { 10 => 20, 40 => 50, 80 => 100, 120 => 150, 200 => 239 }, remove => {}, messy_add => 0, messy_rem => 0, units => 1 };
    base_remove_collapse_test( $start, $end, $range_ref, $test_name );
